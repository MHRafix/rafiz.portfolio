...
const Home = () => {
  ...
  // My Resume Link
  const myResumeLink =
    "https://drive.google.com/file/d/1L8fve5Y3FS1kT1PajfvE2FkhixTa8tVJ/view?usp=sharing";
      ...
      <Box className="flex_layout hero-box">
        ...
        <div className="themeDetails" data-aos="fade-left">
          ...
          <p className="shortDesc">
            Looking for a web developer who can do it all? Look no further! I'm
            a skilled developer with expertise in Next.js for high-performance
            web apps and NestJS for building scalable backend solutions. Plus,
            I'm an expert in Flutter for creating beautiful, cross-platform
            mobile apps. With a strong foundation in GraphQL and MongoDB, I
            deliver seamless, full-stack experiences that bring your ideas to
